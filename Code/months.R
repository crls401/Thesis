...
load("C:\\Users\\u271201\\Downloads\\Mort_Female_65_79\\PM25_Month_rf.RData")
model5 <- model
summary(model5)
...
load("C:\\Users\\u271201\\Downloads\\output\\Mort_Female_65_79\\PM25_Month_rf_nuts.RData")
model2 <- model
summary(model2)
...
load("C:\\Users\\u271201\\Downloads\\output\\Mort_Female_65_79\\NO2_Month_rf.RData")
model5 <- model
summary(model5)
model$summary.random
...
load("C:\\Users\\u271201\\Downloads\\output\\Mort_Female_65_79\\NO2_Month_rf_nuts.RData")
model2 <- model
summary(model2)

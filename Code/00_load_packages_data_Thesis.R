...
g.file <- "C:\\Users\\u271201\\Downloads\\Data\\Sample test\\map.graph"
...
# set data for modelsMort_Female_80_
Y  <- data$Mort_Female65_79  # response variable
N  <- length(Y) # total number of data points
E  <- data$Mort_Female65_79/10^5 # model offset so that response is equivalent to an incidence rate per 100,000 people
